...
namespace THOK.Authority.Bll.Service
{
    public class ModuleService : ServiceBase<Module>, IModuleService
    {
        ...
        private void InitRoleSystem(Role role, City city, THOK.Authority.DbModel.SystemInfo system)
        {
        ...
        private void InitUserSystem(User user, City city,THOK.Authority.DbModel.SystemInfo system)
        {
