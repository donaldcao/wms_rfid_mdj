...
namespace THOK.SMS.Bll.Service
{
    public class SortSupplyService : ServiceBase<SortSupply>, ISortSupplyService
    {
        ...
        {
            IQueryable<SortSupply> sortSupplyQuery = SortSupplyRepository.GetQueryable();
        ...
        public System.Data.DataTable GetSortSupply(int page, int rows, SortSupply sortSupply)
        {
            IQueryable<SortSupply> sortSupplyQuery = SortSupplyRepository.GetQueryable();
