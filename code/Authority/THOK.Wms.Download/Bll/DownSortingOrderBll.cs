...
namespace THOK.Wms.Download.Bll
{
    public class DownSortingOrderBll
    {
        ...
        #region 选择日期从营销系统下载分拣信息（牡丹江浪潮）
        /// <summary>选择日期从营销系统下载分拣信息 2013-09-11 14:38:02 JJ （牡丹江浪潮）</summary>
        ...
        #region 保存订单主表信息到虚拟表，传来的是DATATABLE（牡丹江浪潮）
        /// <summary>保存订单主表信息到虚拟表，传来的是DATATABLE 2013-09-11 13:03:44 JJ （牡丹江浪潮）</summary>
        ...
        #region 保存订单明细到虚拟表（牡丹江浪潮）
        /// <summary>保存订单明细到虚拟表，传来DataTable 2013-09-11 14:47:35 JJ（牡丹江浪潮）</summary>
