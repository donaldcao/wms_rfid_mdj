...
namespace Wms.Controllers.SMS
{
    public class SortAllotController : Controller
    {
        ...
        {
            string strResult = string.Empty;
            bool bResult = DeliverLineOptimizeService.IsWarehousSortIntegration(out strResult);
        ...
        {
            string strResult = string.Empty;
            bool bResult = DeliverLineOptimizeService.DownLoad(beginDate, endDate, out strResult);
        ...
        public ActionResult DownDataSource(string beginDate, string endDate)
        {
            ...
            bool bResult = DeliverLineOptimizeService.DownSortOrder(beginDate, endDate);
